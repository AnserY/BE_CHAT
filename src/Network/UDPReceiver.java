                    ...
                    try {
                        ...
                        if (!messageReceived.getAddress().equals(this.CC.me.myIp)) {
                            ...
                            if (message instanceof MsgHello) {
                                ...
                                for (Iterator<DataAgent> iter = this.CC.me.connectedList.listIterator(); iter.hasNext();) {
                                    DataAgent a = iter.next();
                                    if (a.myIp.equals(messageReceived.getAddress())) {
                                        iter.remove();
                                    }
                                }
                                this.alert();
                            } else if (message instanceof DataAgent) {

                                this.CC.me.connectedList.add((DataAgent) message);
                                this.alert();
                            } else {
